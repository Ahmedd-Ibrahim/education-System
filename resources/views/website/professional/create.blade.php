            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        <form action="{{route('admin.front.professional.store')}}" class="form-horizontal form-bordered" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="control-label col-md-3">name</label>
                                    <div class="col-md-9">
                                        <input type="text" placeholder="professional Name" class="form-control" name="name">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" placeholder="Subject Name" class="form-control" name="job_name">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" placeholder="twitter_link " class="form-control" name="twitter_link">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" placeholder="fb link" class="form-control" name="fb_link">
                                </div>
                                </div>
                                @error('fb_link')
                                <div class="alert alert-danger">    {{$message}} </div>
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" placeholder="gmail link" class="form-control" name="gmail_link">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" placeholder="professional Name" class="form-control" name="insta_link">
