                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="home">
                                <div class="col-md-12">
                                    ...
                                    <form action="{{route('admin.class.store')}}" class="form-horizontal form-bordered" method="POST">
                                        @csrf
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="number" class="form-control" name="container" placeholder="container">
                                                </div>
                                            </div>
                                            ...
                                            <label class="my-1 mr-2" for="phaseYear">Which Phase Year this class Belongs! </label>
