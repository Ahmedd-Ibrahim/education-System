            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        <form action="{{route('admin.food-cycle.update',$foodCycle)}}" class="form-horizontal form-bordered" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" placeholder="Course Name" class="form-control" name="title" value="{{$foodCycle->title}}">
                                    </div>
                                </div>
                                @error('title')
                                ...
                                @enderror
                                <div class="form-group">
                                    <label class="control-label col-md-3">new Course photo</label>
                                    <div class="col-md-9">
                                        ...
                                        <select  name="student_id" class="custom-select my-1 mr-sm-2" id="phase" style="width: 100%">
                                            ...
                                            @if(isset($students) && count($students) > 0)
                                                @foreach($students as $student)
                                                    <option @if($student->id == $foodCycle->Student->id) SELECTED @endif
