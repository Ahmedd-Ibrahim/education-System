    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <form class="form-material form-horizontal" action="{{route('admin.teacher.update',$teacher)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="text" id="example-text" name="name" class="form-control" placeholder="enter your name" value="{{$teacher->name}}" >
                        </div>
                    </div>
                    @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="date" id="bdate" name="bdate" class="form-control mydatepicker" placeholder="enter student birth date" value="{{$teacher->bdate}}" >
                        </div>
                    </div>
                    @error('bdate')
                    <div class="alert alert-danger">    {{$message}} </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="number" id="phone" name="phone" class="form-control " placeholder="enter Your phone Number" value="{{$teacher->phone}}" >
                        </div>
                    </div>
                    @error('phone')
                    <div class="alert alert-danger">  {{$message}} </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="subjects[]" multiple class="form-control" id="exampleFormControlSelect2">
                            @isset($subjects)
                                @foreach($subjects as $subject)
                                    <option @if(in_array($subject->id,$subID)) selected @endif value="{{$subject->id}}">{{$subject->name}}</option>
                                @endforeach
                            @endisset
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <img class="img-responsive" src="{{asset('style/backend/images/'.$teacher->avatar)}}" alt="" style="max-width:120px;">
                        </div>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea name="desc" class="form-control" rows="3"> {{$teacher->desc}}</textarea>
                        </div>
                    </div>
