                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="home">
                                <div class="col-md-12">
                                    ...
                                    <form class="form-material form-horizontal" method="POST" action="{{route('admin.users.update',$user)}}" enctype="multipart/form-data">
                                        @csrf
                                        @method('PATCH')
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" id="example-text" name="name" class="form-control" placeholder="User Name" value="{{$user->name}}">
                                            </div>
                                        </div>
                                        @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="email" id="example-text" name="email" class="form-control" placeholder="email@example" value="{{$user->email}}">
                                            </div>
                                        </div>
                                        @error('email')
                                        <div class="alert alert-danger"> {{$message}} </div>
